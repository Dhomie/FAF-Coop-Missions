...
-- Secondary Objectives
OpC06_M2S1_Title = '<LOC C06_M01_OBJ_030_111>The Star Wars Project'

-- Secondary Objectives
OpC06_M2S1_Desc = '<LOC C06_M01_OBJ_030_112>The UEF will do anything to defend Black Sun, even if it means destroying it along with Earth. They will likely use Strategic Missiles after you captured the Control Center. Construct at least 5 Guardian SMDs (in close proximity) to defend yourself from the UEF warheads.'
