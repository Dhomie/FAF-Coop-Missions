...
local MainScript = '/maps/scca_coop_r06.remastered/SCCA_Coop_R06_script.lua'
...
function AeonMainTransportAttacks()
	...
	Builder = {
        ...
        LocationType = 'M1_Aeon_Main_Base',
		BuildConditions = {
			{'/lua/editor/unitcountbuildconditions.lua', 'HaveGreaterThanUnitsWithCategory', {'default_brain', 10, categories.uaa0104}},
		},
	...
	Builder = {
        BuilderName = 'M2_Aeon_Main_Land_Assault',
        PlatoonTemplate = {
