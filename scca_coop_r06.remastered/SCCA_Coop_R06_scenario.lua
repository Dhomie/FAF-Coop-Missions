...
ScenarioInfo = {
    ...
    starts = true,
    size = {1024, 1024},
    reclaim = {2654749, 82315.22},
    map = '/maps/scca_coop_r06.remastered/SCCA_Coop_R06.scmap',
    save = '/maps/scca_coop_r06.remastered/SCCA_Coop_R06_save.lua',
    script = '/maps/scca_coop_r06.remastered/SCCA_Coop_R06_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
