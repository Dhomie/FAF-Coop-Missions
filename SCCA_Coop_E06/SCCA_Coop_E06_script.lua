...
function IntroMission1()
    ...
    ForkThread(function()
        ...
        while tblArmy[ScenarioInfo['Player' .. i]] do
            ScenarioInfo['Player' .. i .. 'CDR'] = ScenarioFramework.SpawnCommander('Player' .. i, 'Player' .. i .. 'CDR', 'Warp', true, true, PlayerCommanderDestroyed)
			table.insert(ScenarioInfo.CoopCDR, ScenarioInfo['Player' .. i .. 'CDR'])
            WaitSeconds(2)
            i = i + 1
        end
    end)
